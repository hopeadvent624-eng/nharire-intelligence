"""Initial multi-tenancy models (users, organizations, members, workspaces)

Revision ID: 0001_initial_multitenancy
Revises: 
...
revision: str = '0001_initial_multitenancy'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('plan', sa.String(length=50), nullable=False, default='Starter'),
        sa.Column('is_active', sa.Boolean(), nullable=False, default=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint('id')
