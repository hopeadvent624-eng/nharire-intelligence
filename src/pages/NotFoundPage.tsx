  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-[#F8FAFC] text-[#111827] py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-xl w-full text-center space-y-6">
        ...
        <div className="w-20 h-20 rounded-3xl bg-[#DCFCE7] border border-[#22C55E]/40 flex items-center justify-center text-[#0B5D3B] mx-auto shadow-xs">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 text-sm leading-relaxed max-w-md mx-auto">
            The sentinel surveyed the coordinates <code className="text-[#0B5D3B] font-mono bg-[#DCFCE7] px-2 py-0.5 rounded text-xs">{currentPath}</code>, but found no active intelligence records at this location.
          </p>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap justify-center gap-2 text-xs">
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-white border border-gray-200 text-gray-700 hover:text-[#0B5D3B] hover:border-[#0B5D3B]/40 transition-colors shadow-2xs"
            >
