          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6 space-y-3 shadow-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#0B5D3B] font-bold">We aim to respond within 1 business day.</p>
                </div>
              </div>
            ...
            <div className="space-y-3 text-xs text-gray-600">
              ...
              <div className="flex items-center gap-3 bg-white p-5 rounded-2xl border border-[#E5E7EB] shadow-xs">
                <Mail className="w-5 h-5 text-[#0B5D3B] shrink-0" />
                <div>
                  <strong className="block text-gray-900 text-sm mb-0.5 font-bold">Direct Technical Desk</strong>
                  <a href="mailto:inquiries@nharire.com" className="text-[#0B5D3B] font-semibold hover:underline">
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#F8FAFC] border rounded-xl px-4 py-3 text-xs sm:text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 ${
                        errors.name ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-[#0B5D3B]/40'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#F8FAFC] border rounded-xl px-4 py-3 text-xs sm:text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 ${
                        errors.email ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-[#0B5D3B]/40'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#F8FAFC] border rounded-xl px-4 py-3 text-xs sm:text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 ${
                        errors.company ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-[#0B5D3B]/40'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl px-4 py-3 text-xs sm:text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0B5D3B]/40"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#F8FAFC] border border-gray-200 rounded-xl px-4 py-3 text-xs sm:text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#0B5D3B]/40"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full bg-[#F8FAFC] border rounded-xl px-4 py-3 text-xs sm:text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 ${
                      errors.message ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-[#0B5D3B]/40'
                    }`}
                  />
                ...
                <div>
                  <label className="flex items-start gap-3 cursor-pointer text-xs text-gray-600 leading-normal">
                    <input
                      ...
                      className="mt-0.5 rounded border-gray-300 text-[#0B5D3B] focus:ring-[#0B5D3B] w-4 h-4"
                    />
                    <span>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 bg-[#0B5D3B] hover:bg-[#08482e] text-white font-bold py-3.5 px-6 rounded-xl text-sm sm:text-base shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-[#0B5D3B] disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <div className="flex items-center justify-center gap-2 text-gray-500 text-[11px] mt-3">
                    <Lock className="w-3.5 h-3.5 text-[#0B5D3B]" />
